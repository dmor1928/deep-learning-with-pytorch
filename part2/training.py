...
class SegmentationTrainingApp:
    ...
    def main(self):
        ...
        for epoch_ndx in range(1, self.cli_args.epochs + 1):
            ...
            trnMetrics_t = self.doTraining(epoch_ndx, train_dl)  # = self.doTrainingCroppedCT(epoch_ndx, train_dl)

            # train_dl = self.initFullCTTrainDl()
            # trnMetrics_t[batch_size * batch_num:] = self.doTrainingFullCT(epoch_ndx, train_dl)  # Full CT training
            ...
            if epoch_ndx == 1 or epoch_ndx % self.validation_cadence == 0:
                ...
                # val_dl = self.initFullCTValDl()
                # valMetrics_t[batch_size * batch_num:] = self.doValidationFullCT(epoch_ndx, val_dl)

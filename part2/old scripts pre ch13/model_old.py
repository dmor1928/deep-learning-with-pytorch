...
class SegmentationAugmentation(nn.Module):
    ...
    def forward(self, input_g, label_g):
        transform_t = self._build2dTransformMatrix()  # Flip, offset, scaling and rotate applied in build function
        ...
        affine_t = F.affine_grid(transform_t[:, :2], input_g.size(), align_corner=False)

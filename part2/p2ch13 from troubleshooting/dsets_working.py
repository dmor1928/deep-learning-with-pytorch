...
def getCandidateInfoList(requireOnDisk_bool=True):
    ...
    with open('C:/Users/david/PycharmProjects/deep-learning-with-pytorch/part2/luna/candidates.csv', "r") as f:
        for row in list(csv.reader(f))[1:]:
            series_uid = row[0]
...
class Ct:
    def __init__(self, series_uid):
        mhd_path = glob.glob(
            'C:/Users/david/PycharmProjects/deep-learning-with-pytorch/part2/luna/subset*/{}.mhd'.format(series_uid)
        )[0]

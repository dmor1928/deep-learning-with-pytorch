...
def getCandidateInfoList(requireOnDisk_bool=True):  # Returns clean dictionary data, accounting for coord error
    ...
    """
    mhd_list = glob.glob('C:/Users/david/PycharmProjects/deep-learning-with-pytorch/part2/luna/subset*/*.mhd')
    ...
    with open('C:/Users/david/PycharmProjects/deep-learning-with-pytorch/part2/luna/annotations_with_malignancy.csv', "r") as f:
    ...
    with open('C:/Users/david/PycharmProjects/deep-learning-with-pytorch/part2/luna/candidates.csv', "r") as f:  # Append rest of (non-nodule) data from candidates.csv
...
class Ct:  # Load CT scan data of given uid
    def __init__(self, series_uid):
        ...
        mhd_path = glob.glob(
            'C:/Users/david/PycharmProjects/deep-learning-with-pytorch/part2/luna/subset*/{}.mhd'
...
class Luna2dSegmentationDataset(Dataset):
    ...
    def getitem_fullSlice(self, series_uid, slice_ndx):
        ...
        for i, context_ndx in enumerate(range(start_ndx, end_ndx)):
            ...
            context_ndx = max(context_ndx, 0)  # if ndx < 0, set to 0 else do nothing
            context_ndx = min(context_ndx, ct.hu_a.shape[0] - 1)  # if ndx > max ndx = len-1, set to max else do nothing
